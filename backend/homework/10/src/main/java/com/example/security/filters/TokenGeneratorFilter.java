...
public class TokenGeneratorFilter extends OncePerRequestFilter {
    ...
    /**
     * the code generates and attaches a JWT to the response header if the user is authenticated,
     * and then allows the request to continue through the filter chain.
     * @param request
     * @param response
     * @param filterChain
    ...
    /**
     * this method takes a collection of GrantedAuthority objects,
     * extracts their authority strings, removes duplicates, and returns string containing all unique authorities.
     * @param collection
     * @return
     */
