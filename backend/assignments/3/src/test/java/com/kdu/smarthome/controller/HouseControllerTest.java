        ...
        try {
            ...
            mockMvc.perform(MockMvcRequestBuilders.post("/api/v1/house")
                    ...
                    .andDo(result -> {
                        ...
                        Integer houseIdInteger = JsonPath.read(response, "$.house.id");
                        String houseId = houseIdInteger.toString();

//                        String houseId = String.valueOf(JsonPath.read(response, "$.house.id"));
